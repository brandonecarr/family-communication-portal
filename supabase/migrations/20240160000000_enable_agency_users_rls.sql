...
-- Recreate policies to ensure they're applied correctly
DROP POLICY IF EXISTS "Agency users can view their agency users" ON agency_users;
DROP POLICY IF EXISTS "Users can insert their own agency_users record" ON agency_users;
DROP POLICY IF EXISTS "Agency admins can update agency users" ON agency_users;
DROP POLICY IF EXISTS "Agency admins can delete agency users" ON agency_users;
...
-- Allow agency admins to update agency_users in their agency
...
-- Allow agency admins to delete agency_users in their agency
